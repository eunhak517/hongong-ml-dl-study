...
<!-- PROGRESS_START -->
![Progress](https://img.shields.io/badge/Progress-0%20%2F%2028-2EA44F?style=for-the-badge)
...
같은 절에 노트북이 여러 개 있어도 장·절 번호가 같으면 **1개 절로만 계산**됩니다.

> 현재 작성한 노트북 5개를 규칙에 맞게 업로드하면 자동으로 `5 / 28`로 표시됩니다.
